...
public:
	...
	void ExecBool_Integer(CString & strSrc, CString & strValue);
	void ExecBitString(CString & strSrc, CString & strValue);
	void ExecDoubleLong(CString & strSrc, CString & strValue);
	void ExecDoubleLongUnsigned(CString & strSrc, CString & strValue);
	void ExecOctetString_MAC_RN(CString & strSrc, CString & strValue);
	void ExecVisibleString(CString & strSrc, CString & strValue);
	void ExecUTF8String(CString & strSrc, CString & strValue);
	void ExecLong(CString & strSrc, CString & strValue);
	void ExecUnsigned_Enum(CString & strSrc, CString & strValue);
	void ExecLongUnsigned(CString & strSrc, CString & strValue);
	void ExecLong64(CString & strSrc, CString & strValue);
	void ExecLong64Unsigned(CString & strSrc, CString & strValue);
	void ExecFloat32(CString & strSrc, CString & strValue);
	void ExecFloat64(CString & strSrc, CString & strValue);
	void ExecDateTime(CString & strSrc, CString & strValue);
	void ExecDate(CString & strSrc, CString & strValue);
	void ExecTime(CString & strSrc, CString & strValue);
	void ExecDateTimeS(CString & strSrc, CString & strValue);
	void ExecOI(CString & strSrc, CString & strValue);
	void ExecOAD_OMD(CString & strSrc, CString & strValue);
	void ExecROAD(CString & strSrc, CString & strValue);
	void ExecTI(CString & strSrc, CString & strValue);
	void ExecTSA(CString & strSrc, CString & strValue);
	void ExecRegion(CString & strSrc, CString & strValue);
	void ExecScalerUnit(CString & strSrc, CString & strValue);
	void ExecRSD(CString & strSrc, CString & strValue);
	void ExecCSD(CString & strSrc, CString & strValue);
	void ExecMS(CString & strSrc, CString & strValue);
	void ExecSID(CString & strSrc, CString & strValue);
	void ExecSIDMAC(CString & strSrc, CString & strValue);
	void ExecCOMDCB(CString & strSrc, CString & strValue);
	void ExecRCSD(CString & strSrc, CString & strValue);
	void ExecData(CString & strSrc, CString & strValue);
	void ExecOAD_OMD_Tag(CString & strSrc, CString & strValue);
	void ExecROAD_Tag(CString & strSrc, CString & strValue);
	void ExecRSD_Tag(CString & strSrc, CString & strValue);
	void ExecCSD_Tag(CString & strSrc, CString & strValue);
	void ExecRCSD_Tag(CString & strSrc, CString & strValue);
	void ExecData_Tag(CString & strSrc, CString & strValue);
	void ExecDAR_Tag(CString & strSrc, CString & strValue);
	void ExecGetResultNormal(CString & strSrc, CString & strValue);
	void ExecGetResultRecord(CString & strSrc, CString & strValue);
	...
	void GetXmlObjValue(const CString & strXml, std::vector<CString> & vec_strObj, std::vector<CString> & vec_strTValue, std::vector<CString> & vec_strDValue);
	void GetXmlObjValue(CMarkup & xml, std::vector<CString> & vec_strObj, std::vector<CString> & vec_strTValue, std::vector<CString> & vec_strDValue);
	void GetXmlValue(CMarkup & xml, CString & strTValue, CString & strDValue);
	void GetXmlValue(const CString & strXml, CString & strTValue, CString & strDValue);
